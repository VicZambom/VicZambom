# Vic Zambom
### Desenvolvedora Front-end | Entusiasta de ReactTS e TailwindCSS
...
- 📌 Sou uma desenvolvedora front-end aprendiz de **Design UI/UX**. Com foco em **React com TypeScript** e **TailwindCSS**, e agora expandindo meus estudos para **React Native**, busco transformar ideias complexas em aplicações performáticas. Estou sempre em busca de novos desafios e aprendendo sobre as tendências do ecossistema.
